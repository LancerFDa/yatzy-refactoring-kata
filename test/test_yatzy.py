...
def test_threes():
    ...
    assert 0 == Yatzy.threes(2, 1, 5, 4, 6)
...
def test_fours():
    ...
    assert 0 == Yatzy.fours(5, 5, 5, 5, 5)
...
def test_fives():
    ...
    assert 0 == Yatzy.fives(4, 1, 2, 1, 1)
...
def test_one_pair():
    ...
    assert 0 == Yatzy().score_pair(5, 3, 1, 6, 2)
...
def test_three_of_a_kind():
    ...
    assert 0 == Yatzy.three_of_a_kind(3, 2, 1, 4, 5)
